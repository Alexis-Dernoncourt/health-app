...
import {useRecipeDetails} from '../../../hooks/react-query/recipes';
...
import {Ingredient, Step} from '../../../lib/axios/types';
...
const RecipeDetailsScreen = () => {
  ...
  const {params} = useRoute<RouteProp<HomeTabBaseParamList, 'RecipeDetails'>>();
  ...
  const {
    ...
    isLoading,
    error,
  } = useRecipeDetails(params.recipeId);
